...
export const mockFaqs = [
  ...
  { id: 3, questionFr: "Comment fonctionne le suivi en temps réel ?", questionEn: "How does real-time tracking work?", answerFr: "Chaque propriétaire accède à un tableau de bord privé avec toutes les informations : réservations en cours, revenus, dépenses, planning d'occupation.", answerEn: "Each owner has access to a private dashboard with all information: current bookings, revenues, expenses, occupancy schedule.", category: 'general', order: 3, active: true },
